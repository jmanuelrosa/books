...
(function() {
    ...
    angular
        .module('directives.pagination', ['ui.router'])
    ...
    function rsPagination() {
        return {
            ...
            templateUrl: '/scripts/directives/rsPagination/rsPagination.html',
            controller: 'RsPaginationDirCtrl',
            controllerAs: 'vm'
        };
    }

    RsPaginationDirCtrl.$inject = ['$state', '_', 'DEFAULT_MAXPAGES'];
    /**
     ...
     */
    function RsPaginationDirCtrl($state, _, DEFAULT_MAXPAGES) {
        var pages;
        var vm = this;
        ...
        vm.forward = false;
        vm.current = _.parseInt(vm.options.current) || 1;
